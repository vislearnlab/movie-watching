...
CSV_PATH    = "data/stimuli_prompts.csv"   
OUTPUT_DIR  = "output_datavyu_files"  

# =============================================================================
# BODY — no edits needed below
# =============================================================================
...
rows_by_video.each do |video_block, rows|
  ...
  rows.each do |r|
    ...
    setCell(cell, r[:start_ms], r[:end_ms])
  end
  ...
  rows.each do |r|
    cell = coords_col.make_new_cell()
    cell.change_code("prompt_idx", r[:prompt_idx].to_s)
    cell.change_code("x",         "")        # to be filled in by coder
    cell.change_code("y",         "")        # to be filled in by coder
    cell.change_code("include",   "true")    # default; coder can set to false
    setCell(cell, r[:start_ms], r[:end_ms])
  end
